...
function compress(file) {
    ...
    switch (ext) {
        ...
        case '.php': //borramos los php
            console.log('erasing php file ' + file);
            fs.writeFileSync(file, '<eliminado en las apps>', 'utf8'); // overwrite the original unminified file

        case '.scss': //borramos
            console.log('erasing scss file ' + file);
            fs.writeFileSync(file, '<eliminado en las apps>', 'utf8'); // overwrite the original unminified file
